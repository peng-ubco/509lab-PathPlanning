This is the starter code for the ENGR 509 lab about path planning, which shows the open street data can be used to create graph so that the search algorithms can be used for path planning.
